...
pub enum ReleaseType {
    #[serde(rename = "sdist")] Sdist,
    #[serde(rename = "bdist_dumb")] BdistDumb,
    #[serde(rename = "bdist_egg")] BdistEgg,
    #[serde(rename = "bdist_wheel")] BdistWheel,
    #[serde(rename = "bdist_wininst")] BdistWininst,
}
...
pub struct WheelMetadata {
    ...
    #[serde(default)] run_requires: Vec<WheelRequiresGroup>,
    #[serde(default)] test_requires: Vec<WheelRequiresGroup>,
    summary: String,
    version: String,
